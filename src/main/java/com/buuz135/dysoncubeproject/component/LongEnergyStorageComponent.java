...
public class LongEnergyStorageComponent<T extends IComponentHarness> implements IEnergyStorage, 
    INBTSerializable<CompoundTag>, IScreenAddonProvider, IContainerAddonProvider {
    ...
    // Long-based methods for internal use
